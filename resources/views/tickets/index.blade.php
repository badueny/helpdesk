                                        ...
                                        @foreach($tickets as $ticket)
                                            @if($ticket->user_id == Auth::id() || $ticket->assigned_to == Auth::id())
                                                <tr id="{{$ticket->id}}">
                                                    ...
                                                    <td>
                                                        <a href="{{url('ticket')}}/{{$ticket->token_no}}/{{str_replace(' ', '-',   strtolower($ticket->subject) )}}">{{$ticket->subject}}</a></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if(Auth::user()->hasRole('staff'))
                                                            ...
                                                            @endif
                                                        @endif
                                                          <a href="{{url('ticket')}}/{{$ticket->token_no}}/{{str_replace(' ', '-',   strtolower($ticket->subject) )}}">
                                                                    <i class="fa fa-eye"></i>
                                                                </a>  
                                ...
                                <div class="search_box clearfix">
                                    <form action="{{url('find/ticket')}}" method="get">
                                        @if(!empty($search_term))
                                            <input type="text" name="q" class="form-control" placeholder="Masukan No Token" required value="{{$search_term}}">
                                        @else
                                            <input type="text" name="q" class="form-control" placeholder="Masukan No Token" required>
                                        @endif
