...
<div style="width: 100%;">
    ...
    <div style="float: left; background-color: #ef0f72; width: 100%; color: #fff; padding: 5px 5px 15px 5px;">
        <h4 style="line-height: 30px;width: 100%; font-size: 17px; text-align: center; margin: 10px;">Helpdesk Pemprov Banten</h4>
        <p style="text-align: center;">Tiket Baru Telah Dibuat</p>
    </div>
